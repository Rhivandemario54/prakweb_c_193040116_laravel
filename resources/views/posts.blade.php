...
@if ($posts->count())
  <div class="card mb-3">
    ...
    <div class="card-body text-center">
      ...
      <p>
        <small class="text-muted">By. <a href="/blog?author={{ $posts[0]->author->username }}" class="text-decoration-none">{{ $posts[0]->author->name }}</a> in <a href="/blog?category={{ $posts[0]->category->slug }}" class="text-decoration-none"class="text-decoration-none">{{ $posts[0]->category->name }}</a> {{ $posts[0]->created_at->diffForHumans() }}
        </small>
      </p>
    ...
    <div class="col-md-4 mb-3">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p>
            <small class="text-muted">By. <a href="/blog?author={{ $post->author->username }}" class="text-decoration-none">{{ $post->author->name }} {{ $post->created_at->diffForHumans() }}
            </small>
          </p>
